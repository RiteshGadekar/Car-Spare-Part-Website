<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="TataParts.aspx.cs" Inherits="CarSparePart.TataParts" %>
...
<div class="div1" style="margin-left:auto;margin-right:auto;text-align:center">
 <asp:Label ID="Label4" runat="server" Font-Bold="true" Font-Size="X-Large"></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CarSparePartConnectionString %>" SelectCommand="SELECT [ProductId], [Pname], [Pdesc], [Pimage], [Pprice] FROM [Tataparts]"></asp:SqlDataSource>
</asp:Content>
