<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SuzukiParts.aspx.cs" Inherits="CarSparePart.SuzukiParts" %>
...
<asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" Height="293px" Width="310px" RepeatColumns="4" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CarSparePartConnectionString %>" SelectCommand="SELECT [ProductId], [Pname], [Pdesc], [Pimage], [Pprice] FROM [SuzukiParts]"></asp:SqlDataSource>
