<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="SkodaParts.aspx.cs" Inherits="CarSparePart.SkodaParts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:Label ID="Label4" runat="server" Font-Bold="true" Font-Size="X-Large"></asp:Label>
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" Height="293px" RepeatColumns="4" RepeatDirection="Horizontal" Width="310px" OnItemCommand="DataList1_ItemCommand">
        <ItemTemplate>
           <table>
                <tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CarSparePartConnectionString %>" SelectCommand="SELECT [ProductId], [Pname], [Pdesc], [Pimage], [Pprice] FROM [SkodaParts]"></asp:SqlDataSource>
</asp:Content>
